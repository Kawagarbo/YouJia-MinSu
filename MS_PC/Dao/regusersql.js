...
function mysqlClass() {
    ...
    //插入函数
    this.insertuserinto=function(username,passwd,usertel,callback) {
        //插入语句
        var adduser='INSERT INTO user(username,password,usertel) VALUES(?,?,?)';
        //字段的值
        var addparams=[username,passwd,usertel];
